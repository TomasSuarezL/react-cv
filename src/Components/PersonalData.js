    ...
    <div className={"personal-data personal-data-div " + props.collapse}>
      <div className="portrait-name">
        ...
        <div className="name">
          ...
          <div>
            <i className="material-icons">location_on</i>Buenos Aires, Argentina
          </div>
        </div>
      </div>
      <div className="contacto personal-data-section">
        ...
        <div className="contacto-field">
          ...
          <a href="https://github.com/TomasSuarezL">+54 11 31104987 </a>
        </div>
      </div>
